...
class LuckyDipCaseItem(ShopItem):
    ...
    def __init__(self, id: str, name: str, description: str, price: int, use_inventory: bool = True):
        ...
        self.outcomes = [
            ...
            {"type": "ukpence", "weight": 4, "amount": 500, "emoji": "💎", "color": 0x00ff00, "label": "+500 UKPence"},
            # Shutcoins (increased to 40% total)
            ...
            {"type": "shutcoins", "weight": 3, "amount": 10, "emoji": "👑", "color": 0xffd700, "label": "10 Shutcoins"},
            # Timeouts (reduced to 26% total)
            ...
            {"type": "timeout", "weight": 2, "duration": 15, "emoji": "🕐", "color": 0xff3300, "label": "15min timeout"},
