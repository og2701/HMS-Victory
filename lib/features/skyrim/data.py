...
WORLD_BOSSES = {
    "marauder_king": {
        ...
        "hit": ["Your blade bites through a stolen pauldron - he snarls", "You duck a cleaver and open his arm to the elbow", "A feint, a step, and a red line across his ribs"],
        "miss": ["He catches your blow on a looted tower shield", "A warband spearman shoves you off your line"],
        "answer": ["His cleaver comes down like a falling gate", "He backhands you into the hay bales, laughing"],
    ...
    "pale_lady": {
        ...
        "hit": ["Your blow tears through her like smoke - and something in the smoke screams", "Cold parts around your steel; a ribbon of mist burns away", "You strike where her heart should be, and something old cracks"],
        "miss": ["Your blade passes through empty mist - she is already behind you", "She thins to nothing in the instant the blow arrives"],
        "answer": ["Grave-cold fingers close around your sword-arm", "Her wail lands like a physical blow"],
    ...
    "risen_legion": {
        ...
        "hit": ["A whole rank collapses into dust and old mail", "You shear through a shield-wall of the dead", "One sweeping arc fells two of the front rank"],
        "miss": ["Ancient shields lock and your blow skates off", "The ranks part around your swing and close again, patient as tide"],
        "answer": ["A dozen ancient blades dart from the wall at once", "The Legion advances one step, and the step costs you"],
    ...
    "red_hand": {
        ...
        "hit": ["You cut him, and the briar-heart pulses furiously through the wound", "Your blow staggers him mid-warcry", "You split his guard and mark him crown to jaw"],
        "miss": ["He bends like a reed - your blow finds only crag-wind", "The drums swell and your swing goes wide"],
        "answer": ["He strikes with the whole Reach behind the blow", "Briar-thorns rake you as he closes"],
    ...
    "white_terror": {
        ...
        "hit": ["You carve a red furrow through the white hide", "Your blow lands where the fur runs thin - Grahl HOWLS", "He flinches back against a boulder as your strike bites"],
        "miss": ["He takes your blow on a forearm like a glacier shelf", "A wall of snow-spray blinds you mid-swing"],
        "answer": ["A fist the size of a cart door finds you", "He swats you the width of the snowfield"],
    ...
    "otar": {
        ...
        "hit": ["Your blow cracks lightning off his failing wards", "You strike through the storm and the mask SCREAMS", "Old bone gives way beneath your blade"],
        "miss": ["His ward flares blue and drinks the blow whole", "He rises out of reach on a pillar of grave-wind"],
        "answer": ["Lightning arcs from the mask and finds you mid-step", "The barrow-wind slams you against the standing stones"],
    ...
    "greymaw": {
        ...
        "hit": ["You cut him, and he steps back to reassess you - bleeding, unhurried", "Your blow finds old scar tissue; he barely blinks, but it bleeds", "His teeth snap shut on air as your strike lands"],
        "miss": ["He is simply not where you swung. Shepherds' tricks", "He gives ground exactly as far as your reach, and no further"],
        "answer": ["Teeth that learned patience find your shoulder", "He hits you low, where hunters never guard"],
    ...
    "iron_colossus": {
        ...
        "hit": ["Your blow shears a plate loose in a shriek of brass", "Verdigris and sparks - something deep inside skips a beat", "You wedge steel into a seam and LEAN"],
        "miss": ["Your blow rings off four thousand years of Dwemer plate", "A piston hisses, and the seam you aimed for closes"],
        "answer": ["A hammer-arm the size of a ship's mast comes around", "Steam scalds you straight through your guard"],
    ...
    "tide_mother": {
        ...
        "hit": ["You sever an arm; two more take its place, but it COSTS her", "Your blade bites deep into barnacled hide", "She recoils, dragging a wounded arm beneath the surface"],
        "miss": ["An arm takes the blow meant for her eye", "The bay heaves, and your footing goes with it"],
        "answer": ["An arm you never saw closes around your leg", "A boat-length of tentacle slams across the shore"],
    ...
    "sky_shadow": {
        ...
        "hit": ["Your strike finds the wing-joint and the stars stagger", "She banks a heartbeat too late - your blow opens scale", "You strike as she passes, and the night bleeds"],
        "miss": ["She is a hole in the stars, and you miss it", "Her dive breaks your aim before your swing"],
        "answer": ["Talons rake you out of the dark", "Her wake alone knocks you from your feet"],
