...
class TestAClient(unittest.TestCase):
    ...
    @patch("your_discord_bot_file.tree")
    ...
    @patch("your_discord_bot_file.handleRoleButtonInteraction")
    ...
    @patch("your_discord_bot_file.updateRoleAssignments")
    ...
    @patch("your_discord_bot_file.colourPalette")
    ...
    @patch("your_discord_bot_file.gridify")
    ...
    @patch("your_discord_bot_file.persistantRoleButtons")
