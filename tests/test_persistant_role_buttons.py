...
from commands.role_management.persistant_role_buttons import (
...
class TestDiscordBot(unittest.TestCase):
    ...
    @patch(
        "your_module.ROLE_BUTTONS",
        {"123": {"name": "Tester", "description": "A test role"}},
    )
    ...
    async def test_handleRoleButtonInteraction_component(self, mock_interaction_type):
        ...
        self.interaction.response.send_message.assert_awaited_once_with(
            "Role Tester assigned.", ephemeral=True
        )
