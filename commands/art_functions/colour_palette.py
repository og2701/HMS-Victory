...
async def colourPalette(interaction, attachment_url: str):
    ...
    for i, colour in enumerate(colours):
        ...
        draw.text((60, i*50 + 10), f'{hex_colour} RGB({colour[0]}, {colour[1]}, {colour[2]})', fill='black')
    ...
    rgb_int = most_significant_colour[0] * 65536 + most_significant_colour[1] * 256 + most_significant_colour[2]
    result_embed = Embed(
