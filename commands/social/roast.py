...
async def roast(interaction, channel: TextChannel = None, user: Member = None):
    ...
    system_prompt = (
        ...
        "Channel cynical British comedic invective (think Malcolm Tucker meets Frankie Boyle). "
        "CRITICAL VARIETY RULES - NO REPETITIVE TEMPLATES: "
        f"- DO NOT start with '{user.display_name} chats like a...', '{user.display_name} is the sort of...', or '[verb] like a fucking...'. "
        "- Banned repetitive crutches: NEVER use 'trapped in a [queue/Costa/Greggs]', NEVER use 'You're not a man, you're a...', "
        "and do NOT lean on 'like a fucking [noun]' as a lazy crutch. Vary your sentence structures across the board! "
        "- Vary the swearing: use the full colourful British palette (bollocks, gobshite, shite, wanker, twat, pillock, "
        "taking the piss, bloody, etc.) with natural comedic rhythm, rather than using 'fucking' as an adjective in every sentence. "
