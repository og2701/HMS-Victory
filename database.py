...
def init_db():
    with DatabaseManager.get_connection() as conn:
        ...
        badges = [
            ...
            ('sky_dragon_hunter', 'Dragon Hunter', 'Take the souls of 10 dragons', '🏔️', 'Silver'),
            ('sky_harbinger', 'Harbinger', 'Reach the top rank of any faction', '⚜️', 'Silver'),
            ('sky_pit_champion', 'Pit Champion', "Take the top title in Windhelm's pit", '🗡️', 'Silver'),
            ('sky_into_the_dark', 'Into the Dark', 'Reach floor 20 of the Soul Cairn and crawl back', '🕳️', 'Silver'),
