...
def init_db():
    with DatabaseManager.get_connection() as conn:
        ...
        badges = [
            ...
            ('sky_dovahkiin', 'Dragonborn', 'Finish your first delve in Skyrim', '🐉', 'Bronze'),
            ('sky_arrow_knee', 'Arrow to the Knee', 'Trip the tripwire and take one in the knee', '🏹', 'Bronze'),
            ('sky_sweetroll', 'Sweetroll', 'Eat a sweetroll you found in a dungeon', '🍩', 'Bronze'),
            ('sky_cloud_district', 'The Cloud District', 'Run into Nazeem underground, of all places', '☁️', 'Bronze'),
            ('sky_low_orbit', 'Low Orbit', 'Get launched into the sky by a giant', '🦣', 'Bronze'),
            ('sky_unmarked_grave', 'Unmarked Grave', 'Die on a delve and leave a corpse behind', '⚰️', 'Bronze'),
            ('sky_stray', 'Stray', 'Befriend something that followed you home', '🐾', 'Bronze'),
            ('sky_maiq', "M'aiq Knows", "Cross paths with M'aiq the Liar", '🐱', 'Bronze'),
            ('sky_locksmith', 'Master Locksmith', 'Take Lockpicking all the way to 100', '🔓', 'Silver'),
            ('sky_thuum', "Thu'um", 'Learn all three Words of Unrelenting Force', '🗣️', 'Silver'),
            ('sky_dragon_hunter', 'Dragon Hunter', 'Take the souls of 10 dragons', '🐲', 'Silver'),
            ('sky_harbinger', 'Harbinger', 'Reach the top rank of any faction', '🏰', 'Silver'),
            ('sky_pit_champion', 'Pit Champion', "Take the top title in Windhelm's pit", '🗡️', 'Silver'),
            ('sky_into_the_dark', 'Into the Dark', 'Reach floor 20 of the Soul Cairn and crawl back', '💀', 'Silver'),
            ('sky_long_road', 'The Long Road', 'Delve 14 days running without breaking the streak', '🔥', 'Silver'),
            ('sky_thane', 'Thane', 'Raise the Small Hall on your Lakeview land', '🏡', 'Silver'),
            ('sky_wonder', 'Wonder-Keeper', 'Find one of the Wonders of Skyrim', '✨', 'Silver'),
            ('sky_world_eater', 'World-Eater', 'Slay Alduin', '🌑', 'Gold'),
            ...
            ('sky_no_stone_unturned', 'No Stone Unturned', 'Complete the Skyrim collection log', '🗺️', 'Gold'),
